...
function (_super) {
  ...
  function DataSource(instanceSettings) {
    ...
    _this.user = (instanceSettings.jsonData || {}).user || '';
    ...
    _this.headers['user'] = _this.user;
    _this.headers['password'] = _this.password;
    return _this;
  }
  ...
  DataSource.prototype.query = function (request) {
    ...
    var queries = targets.map(function (q) {
      ...
      if (q.datasource === ExpressionDatasourceID) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, q), {
    ...
    return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(req);
  };
...
function (_super) {
  ...
  function QueryEditor(props) {
    ...
    _this.onFieldChange = function (query) {
      _this.query.queryText = query.target.value;
    };
